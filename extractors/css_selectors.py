...
# (label_sel, value_sel) — flat zip-based pairing
SITE_PATTERNS: dict[str, list[tuple[str, str]]] = {
    "techpowerup.com": [
        ("section.techpowerup-specs dl dt", "section.techpowerup-specs dl dd"),
        (".gpuz-specs table tr td:first-child", ".gpuz-specs table tr td:last-child"),
    ],
    "gsmarena.com": [
        ("table.specs-list tr td.ttl", "table.specs-list tr td.nfo"),
    ],
    "notebookcheck.net": [
        ("table.datasheet tr th", "table.datasheet tr td"),
    ],
    "anandtech.com": [
        ("table.specification tr td:first-child", "table.specification tr td:last-child"),
    ],
    "rtings.com": [
        ("table.test-results tr td:first-child", "table.test-results tr td:last-child"),
    ],
}

# (row_container_sel, label_within_row_sel, value_within_row_sel)
SITE_ROW_PATTERNS: dict[str, tuple[str, str, str]] = {
    "asus.com": (
        "[class*=rowTable__]",
        "[class*=rowTableTitle]",
        "[class*=rowTableItemViewBox]",
    ),
}
...
class CSSExtractor(BaseExtractor):
    def extract(
        ...
        for site_key, row_pattern in SITE_ROW_PATTERNS.items():
